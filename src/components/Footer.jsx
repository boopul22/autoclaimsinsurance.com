      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li className="flex items-start gap-2 text-xs sm:text-sm text-gray-400">
                ...
                C/O Nra Accountancy, Arrow Mill, Queensway, Rochdale, Lancashire, England, OL11 2YW
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-6 sm:pt-8 mb-4 sm:mb-6">
          <p className="text-xs sm:text-sm text-gray-400 mb-3 leading-relaxed">
            ...
            Insuranceautoclaim.com is operated by Evolve Web Marketing Ltd, Company No. 15814738,
            registered in England & Wales. Registered Office: C/O Nra Accountancy, Arrow Mill,
            Queensway, Rochdale, Lancashire, England, OL11 2YW.
          </p>
        </div>
        ...
        <div className="bg-white/5 rounded-lg sm:rounded-xl p-4 sm:p-5 mb-6 sm:mb-8">
          <p className="text-[10px] sm:text-xs text-gray-400 leading-relaxed">
            ...
            15814738). Insuranceautoclaim.com is not a law firm, a lawyer referral service, or
